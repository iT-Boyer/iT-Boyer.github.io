...
t = function() {
            ...
            return function e(t, i, o) {
                if (k(t)) if (i[o]) {
                    ...
                    if (o === i.length - 1 && (g(c) || y(c) || p(c))) n.push(function(e) {
                        ...
                        r = !0;
                        for (var a = 0,
                        s = c.length; a < s; a += 1) e(c[a], i, o + 1)
    ...
    var E = function() {
        ...
        },
        {
            key: "create",
            value: function() {
                var e = this; ! this.isCreated && this.docs.length && (this.isCreated = !0, g(this.docs[0]) ? this.docs.forEach((function(t, n) {
                    e._addString(t, n)
        ...
        },
        {
            ...
            value: function(e) {
                ...
                for (var t = e,
                n = this.size(); t < n; t += 1) this.records[t].i -= 1
            }
        },
        {
        ...
        function e(n) {
            ...
            this.pattern = m ? n: n.toLowerCase(), this.chunks = [], this.pattern.length) {
                ...
                if (x > 32) {
                    for (var L = 0,
                    S = x % 32,
                    w = x - S; L < w;) b(this.pattern.substr(L, 32), L),
                    L += 32;
                    if (S) {
                        var _ = x - 32;
            ...
            value: function(e) {
                ...
                this.chunks.forEach((function(t) {
                    ...
                    y = function(e, t, n) {
                        ...
                        for (var m, k = t.length,
                        M = e.length,
                        b = Math.max(0, Math.min(o, M)), x = u, S = b, w = d > 1 || g, _ = w ? Array(M) : []; (m = e.indexOf(t, S)) > -1;) {
                            var O = R(t, {
                                currentLocation: m,
                                expectedLocation: b,
                                distance: a,
                            ...
                            if (x = Math.min(O, x), S = m + k, w) for (var j = 0; j < k;) _[m + j] = 1,
                            j += 1
                        }
                        S = -1;
    ...
    B = function(e) {
        ...
        return r(i, [{
            ...
            value: function(e) {
                for (var t, n = 0,
                r = [], i = this.pattern.length; (t = e.indexOf(this.pattern, n)) > -1;) n = t + i,
                r.push([t, n - 1]);
                var o = !!r.length;
                return {
                    isMatch: o,
    ...
    ue = function(e) {
        return i({},
        ne, Object.keys(e).map((function(t) {
            return i({},
            t, e[t])
        })))
    };
                ...
                return r.forEach((function(e) {
                    ...
                    if (k(r)) {
                        ...
                        o.push(i[c])), a.forEach((function(e) {
                            var t, n = e.matches; (t = i[c].matches).push.apply(t, l(n))
                        })))
                    }
                })),
                o
